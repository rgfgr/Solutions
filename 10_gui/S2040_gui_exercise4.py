...
treeview.column("Weight", anchor=tk.E, width=80)
...
treeview.tag_configure('oddrow', background=oddrow)
treeview.tag_configure('evenrow', background=evenrow)

treeview.bind("<ButtonRelease-1>", lambda event: edit_record(event, treeview))
# endregion
